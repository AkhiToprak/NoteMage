...
// Phase 9.3 — /learn/paths. Moved verbatim from /learn/page.tsx; the parent
// (dashboard)/learn/layout.tsx now provides the tab strip wrapper, so the
// page just renders its panel content.
