 ...
 *
 * This is the client-only View half. Initial data arrives as props from the
 * async server page (no on-mount fetch, no loading spinner). */
...
export default function ExamResultEntryView({ examId, ctx }: { examId: string; ctx: ResultEntryContext }) {
  const router = useRouter();

  // requiredCorrection: called unconditionally with ctx.exam.title directly (ctx is never null here)
