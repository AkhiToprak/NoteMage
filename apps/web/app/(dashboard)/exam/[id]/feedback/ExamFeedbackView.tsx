 ...
 *
 * Receives exam data resolved server-side. Keeps all interactive state and
 * the POST /api/user/exams/[id]/feedback mutation client-side.
 *
...
export default function ExamFeedbackView({ examId, exam }: ExamFeedbackViewProps) {
  useRegisterMageContext({ type: 'exam', ids: { examId }, title: exam.title });

  return (
    <AppShell>
      <FeedbackForm examId={examId} exam={exam} />
    </AppShell>
  );
}
