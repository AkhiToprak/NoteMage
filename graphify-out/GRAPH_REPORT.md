...
## Corpus Check
- 914 files · ~1,107,482 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5392 nodes · 12525 edges · 276 communities (242 shown, 34 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 184 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6c3174c0`
...
## Communities (276 total, 34 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (125): GET(), PathAccessResponse, mocks, GET(), Params, POST(), GET(), GET() (+117 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (90): createSemaphore(), Semaphore, attachFigureStats(), buildDiagramClozeQuestion(), bulletList(), captureFlashcardConceptKeys(), DIAGRAM_CLOZE_STEMS, diagramClozeStem() (+82 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (77): Params, POST(), POST(), CodeExecuteBody, CodeExecuteTest, isExecutableLanguage(), normalizeOutput(), POST() (+69 more)
...
Cohesion: 0.09
Nodes (55): DELETE(), POST(), POST(), GET(), POST(), DELETE(), POST(), GET() (+47 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (65): AccountSettingsPage(), SPARKS, buildPrediction(), clamp01(), buildReflectionTake(), capitalize(), DIFFICULTY_OPTIONS, DifficultyFelt (+57 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (42): MageRevealingParts, QuizViewerProps, ghostExtra, GradedResultAction, GradedResultPanelProps, primaryBtnStyle, AskMageCard(), MissionProgress() (+34 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (38): ACTIVITY_ICONS, ACTIVITY_LABELS, ActivityListProps, CheckpointDrawerProps, SLOT_KIND_LABEL, CheckpointFlashcardViewerProps, Flashcard, FlashcardImageData (+30 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (51): register(), runJob(), mocks, BACKGROUND_JOB_STATUSES, BackgroundJobStatus, BACKOFF_MS, bootstrapDeletionSweep(), bootstrapReminderSweep() (+43 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (50): DashboardLayout(), clamp(), dedupTopics(), DEFAULT_MOCK_KINDS, defaultMockConfig(), durationLabel(), MOCK_DIFFICULTIES, MOCK_DIFFICULTY_LABEL (+42 more)

### Community 10 - "Community 10"
Cohesion: 0.08
Nodes (52): PathAssessmentSpec, PathSlotKind, QuizForSlotToolInput, quizPayloadCatalogFor(), quizShapeExamples(), callQuizDispatch(), SlotForGeneration, tryDegradedQuiz() (+44 more)
...
Cohesion: 0.07
Nodes (40): detectImageType(), MAGIC_BYTES, POST(), buildTextSample(), ClassifyFile, POST(), DELETE(), POST() (+32 more)

### Community 13 - "Community 13"
Cohesion: 0.08
Nodes (47): CLASSIFY_SUBJECTS_TOOL, AiUsageEvent, logAiUsage(), globalForAnthropic, generateAndPersistTitle(), sanitizeTitle(), generateReportNarrative(), geminiStructured() (+39 more)
...
Cohesion: 0.06
Nodes (33): AdminDashboardPage(), fmtNum(), Stats, DashboardView(), DashboardGreeting(), DashboardGreetingProps, Breakpoint, BreakpointResult (+25 more)
...
Cohesion: 0.08
Nodes (35): buildWeaknessNudgeSubject(), C, getAppUrl(), getFromAddress(), getResend(), leadTrigger(), renderWeaknessNudgeEmail(), sendWeaknessNudgeEmail() (+27 more)

### Community 23 - "Community 23"
Cohesion: 0.09
Nodes (33): activityMeta(), AskMageCard(), finalExamSlot(), MissionState, missionStateFor(), MsIcon(), nextActivity(), nodeBadgeLabel() (+25 more)
...
Cohesion: 0.06
Nodes (33): ConceptWeakAreaRow, ConceptWeakAreaRowWithMergeInfo, loadConceptWeakAreaRows(), LoadConceptWeakAreaRowsOptions, RawMasteryRow, mocks, unionGroup(), buildLegacyColumns() (+25 more)

### Community 26 - "Community 26"
Cohesion: 0.08
Nodes (33): BackfillClassifyToolInput, backfillEvents(), buildClassifyTool(), buildGeminiJsonInstruction(), ClassifyItem, classifySlot(), loadConceptTagsByQuestion(), runConceptBackfill() (+25 more)

### Community 27 - "Community 27"
Cohesion: 0.08
Nodes (24): masteryScore(), attachUpstreamGapHints(), buildWhyFlagged(), computeImpactPoints(), ConceptEdgeForHints, ConceptWeakArea, ConceptWeakAreaColdStart, ConceptWeakAreaCoverage (+16 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (35): generateWithRepair(), RepairResult, OnboardingSourceKind, GeneratedPathStructure, GeneratePathStructureOpts, theoryPlainText(), PathLanguageCode, defaultSourceLabel() (+27 more)

### Community 29 - "Community 29"
Cohesion: 0.10
Nodes (35): POST(), resolveUserId(), POST(), resolveUserId(), AccountState, AccountStateFields, activeGrant(), BillingFields (+27 more)
...
Cohesion: 0.08
Nodes (28): CancelPathDialog(), DeletePathDialog(), ResetPathDialog(), loadPathReadinessInputs(), derivePathStats(), findContinueSlot(), PathOverviewStats, PathTopicMastery (+20 more)

### Community 32 - "Community 32"
Cohesion: 0.09
Nodes (28): jaccard(), STOPWORDS, candidate(), tier1Match(), Tier1MatchCandidate, tokenize(), ConceptTrackingAnswer, enqueueBackfillForUntaggedQuestions() (+20 more)
...
Cohesion: 0.14
Nodes (35): captureQuizConceptKeys(), asBoolean(), asFlexibleString(), asNonEmptyString(), extractOptionText(), isMarkedCorrect(), isPlainObject(), normalizeAssessmentSpec() (+27 more)
...
Cohesion: 0.09
Nodes (21): LEGAL, RESOURCES, Row, DEFAULTS, Prefs, REMINDER_ROWS, EMPTY_GOAL_VALUES, GOAL_CONFIGS (+13 more)
...
Cohesion: 0.08
Nodes (25): CalendarScreen(), CalendarView(), CalendarViewProps, DayCard(), dayDescription(), dayHeadline(), ExamDayCard(), ExamMeta (+17 more)
...
Cohesion: 0.13
Nodes (28): applyEvent(), AttemptEvent, chancePForKind(), classifyBand(), computeEventDelta(), countDistinctCalendarDays(), decaySums(), EventDelta (+20 more)

### Community 47 - "Community 47"
Cohesion: 0.12
Nodes (27): DashboardViewProps, DashboardPage(), buildDashboardData(), DashboardActivePath, dashboardCacheKey(), DashboardData, deriveDashboardDataFromPaths(), deriveNextCheckpoint() (+19 more)

### Community 48 - "Community 48"
Cohesion: 0.07
Nodes (17): Derived, FetchState, ExamHubViewProps, PathPhase, PathPlan, UltraBadge(), BAND_META, BAND_ORDER (+9 more)

### Community 49 - "Community 49"
Cohesion: 0.08
Nodes (21): ScopeCandidates, ScopeItemRef, BADGE_CLASS, classifyNode(), classifyWeak(), countdownLabel(), ExamHub(), ExamHubView() (+13 more)

### Community 50 - "Community 50"
Cohesion: 0.08
Nodes (14): useCoarsePointer(), ReviewGrade, ReactionMode, AnswerEntry, QuestionImageData, QuizMode, QuizQuestion, QuizViewer() (+6 more)
...
Cohesion: 0.11
Nodes (23): getAuthContext(), startChatStream(), formatExamStudyState(), clampDailyMinutes(), flashcardReviewQueueEnabled(), mageGenerationActionsEnabled(), webSearchDisabled(), dbGroundingLoader() (+15 more)
...
Cohesion: 0.13
Nodes (23): ANNOTATE_ANSWER_TOOL, CHAT_STUDY_PLAN_TOOL, extractToolUses(), FLASHCARD_TOOL_WITH_FIGURES, MINDMAP_TOOL, PRESENTATION_TOOL, QUIZ_TOOL_V2_WITH_FIGURES, YOUTUBE_VIDEOS_TOOL (+15 more)
...
Cohesion: 0.14
Nodes (8): AnswerSubmission, lowlight, AnyQuestionRenderer, Token, QuestionProps, QuizQuestionForRender, QuizRenderMode, UserAnswer
...
Cohesion: 0.12
Nodes (19): CODES, isPathLanguage(), normalizePathLanguage(), PATH_LANGUAGES, POPULAR_PATH_LANGUAGE_CODES, turnstileConfigured(), verifyTurnstile(), assembleTimestampedTranscript() (+11 more)

### Community 69 - "Community 69"
Cohesion: 0.12
Nodes (17): AppearanceSettingsPage(), ReactionsMode, ResolvedTheme, ThemeContext, ThemeContextValue, ThemePreference, useTheme(), ensureStorageListener() (+9 more)
...
Cohesion: 0.13
Nodes (18): deleteFile(), saveImage(), anthropicVisionEngine, cropFigure(), NormalizedBbox, withTableEscalation(), deriveTitle(), EMPTY_DOC (+10 more)
...
Cohesion: 0.10
Nodes (17): getCosmetic(), CandidateGroupKey, ExamScopeEditorProps, GROUPS, ScopeCandidate, haptics, CONFETTI, CONFETTI_COLORS (+9 more)
...
Cohesion: 0.13
Nodes (15): ImportGroup, ImportJobInfo, ImportMode, ImportPhase, PALETTE, PickedFile, PreparedFile, UseMultiImportOptions (+7 more)

### Community 80 - "Community 80"
Cohesion: 0.13
Nodes (21): resolveSubjectId(), SubjectIcon(), ClassifySubjectsResult, isSubjectId(), SUBJECT_IDS, SubjectId, CallResult, EVAL_SUBJECTS (+13 more)
...
Cohesion: 0.17
Nodes (18): ExpiredBody(), fmtDate(), INTERVALS, PausedBody(), Props, useIosSheet(), WelcomeBody(), useCurrency() (+10 more)
...
Cohesion: 0.15
Nodes (14): jumpPill, LegalPageShellProps, LegalNoticePage(), metadata, CONTENT_DIR, getLegalContent(), LegalLang, LegalSlug (+6 more)
...
Cohesion: 0.17
Nodes (17): TipTapDoc, TipTapMark, TipTapNode, TipTapTextNode, assembleTiptap(), captionParagraph(), clampHeadingLevel(), convertBlock() (+9 more)
...
Cohesion: 0.16
Nodes (15): bigStreakShouldFire(), buildReaction(), computeReaction(), CopyTier, pickCopy(), QUIZ_REACTION_COPY, isPermitted(), MINIMAL_ALLOWED (+7 more)
...
Cohesion: 0.17
Nodes (13): APPLE_JWKS, AppleIdTokenClaims, NativeApplePayload, POST(), hydrateTokenFromDb(), findOrCreateOAuthUser(), mocks, allowedAudiences() (+5 more)
...
Cohesion: 0.19
Nodes (12): UPLOAD_RULES, videoMimeFromName(), VideoIngestError, deriveVideoPageTitle(), notesToPageDoc(), EMPTY_DOC, minutesFromTokens(), progressJson() (+4 more)
...
Cohesion: 0.21
Nodes (10): AccountGateOverlay(), AccountGateServerGate(), deriveAccountState(), getServerAuthToken(), PROFILE_SELECT, ProfilePage(), ProfileData, UnlockedItem (+2 more)
...
Cohesion: 0.21
Nodes (9): authOptions, logOAuthDenial(), oauthProviders, AuthenticatedContext, mocks, validateAuthToken(), validAuthVersion(), logSecurityEvent() (+1 more)
...
Cohesion: 0.14
Nodes (7): UsageEntry, VideoMaterialPickerProps, readYouTubeDuration(), Window, YTNamespace, YTPlayer, VideoUrlConfirm
...
Cohesion: 0.22
Nodes (12): FeatureType, getMonthStart(), getPeriodStart(), getWeekStart(), LIFETIME_LIMITS, PPP_CURRENCIES, PPP_PRICE, PRO_WEEKLY_LIMITS (+4 more)
...
Cohesion: 0.21
Nodes (5): metadata, TOPICS, FOOTER_LINKS, MageFooter(), LINKS
...
Cohesion: 0.23
Nodes (8): ModalDimensions, useModalDimensions(), PrepareProgress, useMultiImport(), ImportPreparingStepProps, MultiPdfImportModal(), MultiPdfImportModalProps, EditProfileModal()
...
Cohesion: 0.29
Nodes (9): binomialUpperTailPValue(), computeDominantDistractor(), ComputeDominantDistractorInput, ConceptMisconception, deriveConceptMisconception(), DominantDistractor, logBinomialCoefficient(), logFactorial() (+1 more)
...
Cohesion: 0.20
Nodes (3): Mascot(), POSE, SceneState
...
Cohesion: 0.29
Nodes (7): AnthropicChatMessage, streamChatGLM(), StreamChatGLMOptions, OpenRouterMessage, OpenRouterStreamHandlers, anthropicToolsToOpenAI(), toolChoiceToOpenAI()
...
Cohesion: 0.25
Nodes (6): IosUpgradeSheetProps, formatDate(), SubInfo, SubscriptionPanel(), TIER_COLORS, TIER_NAMES

### Community 187 - "Community 187"
Cohesion: 0.39
Nodes (8): VideoNoteBlock, VideoNotes, blockToNodes(), blockToPlainText(), headingNode(), paragraph(), textNode(), withTimestamp()
...
## Knowledge Gaps
- **1746 isolated node(s):** `semi`, `trailingComma`, `singleQuote`, `printWidth`, `tabWidth` (+1741 more)
...
- **Why does `internalErrorResponse()` connect `Community 0` to `Community 2`, `Community 35`, `Community 4`, `Community 99`, `Community 232`, `Community 12`, `Community 52`, `Community 149`, `Community 54`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `useBreakpoint()` connect `Community 15` to `Community 36`, `Community 5`, `Community 70`, `Community 7`, `Community 40`, `Community 105`, `Community 6`, `Community 11`, `Community 43`, `Community 50`, `Community 148`, `Community 87`, `Community 89`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `successResponse()` connect `Community 0` to `Community 2`, `Community 35`, `Community 4`, `Community 232`, `Community 12`, `Community 52`, `Community 149`?**
