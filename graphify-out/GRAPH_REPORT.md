# Graph Report - web  (2026-07-05)

## Corpus Check
- 907 files · ~1,103,993 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5359 nodes · 12432 edges · 267 communities (234 shown, 33 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 184 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a05dac08`
...
2. `getAuthUserId()` - 232 edges
3. `unauthorizedResponse()` - 227 edges
4. `successResponse()` - 220 edges
...
10. `useRegisterMageContext()` - 37 edges
...
Cohesion: 0.06
Nodes (92): POST(), POST(), GET(), POST(), CodeExecuteBody, CodeExecuteTest, isExecutableLanguage(), normalizeOutput() (+84 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (65): GET(), PathAccessResponse, mocks, GET(), Params, DELETE(), POST(), GET() (+57 more)
...
Cohesion: 0.05
Nodes (78): attachFigureStats(), buildDiagramClozeQuestion(), callQuizDispatch(), captureFlashcardConceptKeys(), captureQuizConceptKeys(), ModelUsage, DIAGRAM_CLOZE_STEMS, diagramClozeStem() (+70 more)
...
Cohesion: 0.07
Nodes (59): resolveSubjectId(), SubjectIcon(), PathAssessmentSpec, PathSlotKind, QuizForSlotToolInput, quizPayloadCatalogFor(), quizShapeExamples(), ClassifySubjectsResult (+51 more)
...
Cohesion: 0.06
Nodes (42): AdminLayout(), AdminUser, NAV_ITEMS, NavItem, ActionButton(), AdminConsoleStyles(), AdminHeader(), Chip() (+34 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (31): AppShell(), CalendarScreen(), CalendarView(), CalendarViewProps, DayCard(), dayDescription(), dayHeadline(), ExamDayCard() (+23 more)

### Community 11 - "Community 11"
Cohesion: 0.07
Nodes (44): applyEvent(), AttemptEvent, chancePForKind(), classifyBand(), computeEventDelta(), countDistinctCalendarDays(), decaySums(), EventDelta (+36 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (31): QuestionNavigatorItem, ResolveResult, MockDetail, MockExamRunner(), MockExamRunnerProps, RunnerQuestion, RunnerSet, useMockCountdown() (+23 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (51): AnnotateAnswerToolInput, ClassifySubjectsToolInput, CONCEPT_CANDIDATES_PROPERTY, CONCEPT_KEYS_PROPERTY, FLASHCARD_FIGURE_PROPERTY, FLASHCARD_TOOL, FLASHCARDS_FOR_SLOT_TOOL_BASE, FlashcardsForSlotToolInput (+43 more)

### Community 14 - "Community 14"
Cohesion: 0.07
Nodes (43): DashboardView(), DashboardViewProps, DashboardPage(), buildDashboardData(), DashboardActivePath, dashboardCacheKey(), DashboardData, deriveDashboardDataFromPaths() (+35 more)

### Community 15 - "Community 15"
Cohesion: 0.10
Nodes (37): NotFound(), StudyCalendarPage(), ExamFeedbackPage(), GET(), Params, ProgressPayload, SnapshotEnvelope, ExamPathHubPage() (+29 more)

### Community 16 - "Community 16"
Cohesion: 0.10
Nodes (34): ALLOWED_MIME_TYPES, extractText(), ensureWorkerOnDisk(), extractPdfText(), extractPdfTipTapNodes(), getPdfjs(), loadPdfjs(), processPage() (+26 more)

### Community 17 - "Community 17"
Cohesion: 0.08
Nodes (39): bestGrade(), gradeFromStars(), derivePathStats(), activityMeta(), AskMageCard(), finalExamSlot(), MissionState, missionStateFor() (+31 more)
...
Cohesion: 0.09
Nodes (43): logAiUsage(), tiptapJsonToPlainText(), AssembledMock, assembleMockExam(), difficultyInstruction(), NormalizedUsage, recordPreviewUsage(), AssembledPracticeQuiz (+35 more)

### Community 20 - "Community 20"
Cohesion: 0.08
Nodes (36): register(), runJob(), mocks, BACKGROUND_JOB_STATUSES, BackgroundJobStatus, BACKOFF_MS, bootstrapReminderSweep(), claimNextJob() (+28 more)
...
Cohesion: 0.06
Nodes (41): generateWithRepair(), RepairResult, bulletList(), GeneratedPathStructure, pathDiagramNode(), pathImageNode(), splitParagraphs(), theoryInputToTipTap() (+33 more)

### Community 23 - "Community 23"
Cohesion: 0.06
Nodes (39): BatchResult, captionBatch(), captionMissing(), CaptionTarget, CaptionUsageContext, GeminiPart, PLACEHOLDER_CAPTIONS, sanitizeCaption() (+31 more)

### Community 24 - "Community 24"
Cohesion: 0.08
Nodes (28): DocModelBlock, anthropicVisionCall(), CACHED_SYSTEM, ModelCall, canonicalizeImageRefs(), DescribePageInput, createGeminiEngine(), geminiEngine (+20 more)

### Community 25 - "Community 25"
Cohesion: 0.07
Nodes (40): LEARNING_SLOT_BATCH_TOOL, openRouterMaxCompletionTokens(), OpenRouterUsage, computeCost(), computeModelCost(), CostBreakdown, costForCall(), COSTS (+32 more)

### Community 26 - "Community 26"
Cohesion: 0.08
Nodes (34): detectImageType(), MAGIC_BYTES, POST(), buildTextSample(), ClassifyFile, POST(), DELETE(), cancelLemonSqueezySubscription() (+26 more)

### Community 27 - "Community 27"
Cohesion: 0.08
Nodes (21): BackgroundCosmetic, BaseCosmetic, Cosmetic, COSMETICS, CosmeticType, FrameCosmetic, NameColorCosmetic, NameFontCosmetic (+13 more)
...
Cohesion: 0.07
Nodes (30): AdminDashboardPage(), fmtNum(), Stats, useBreakpoint(), useCoarsePointer(), ExamHubView(), BurgerMenu(), AskMageButton() (+22 more)
...
Cohesion: 0.08
Nodes (25): AccountSettingsPage(), ReactionsMode, LEGAL, RESOURCES, Row, DEFAULTS, Prefs, REMINDER_ROWS (+17 more)

### Community 34 - "Community 34"
Cohesion: 0.09
Nodes (29): GET(), Params, PATCH(), PatchBody, toUnlockedPayload(), POST(), AssessmentBody, Params (+21 more)

### Community 35 - "Community 35"
Cohesion: 0.07
Nodes (26): buildActivityCreate(), buildPhasesCreate(), CloneSourceActivity, CloneSourceFlashcardSet, CloneSourcePhase, CloneSourceQuizSet, CloneSourceSlot, CloneSourceTheory (+18 more)

### Community 36 - "Community 36"
Cohesion: 0.06
Nodes (26): LessonPage(), LESSONS, CelebrationToast(), CelebrationToastProps, DifficultyBadge(), DifficultyBadgeProps, DifficultyLevel, DifficultySize (+18 more)
...
Cohesion: 0.08
Nodes (28): useCurrency(), useUpgrade(), CHECKOUT_URL_BY_INTERVAL, CHECKOUT_URL_BY_INTERVAL_PPP, loadLemon(), openProCheckout(), OpenProCheckoutOptions, PPP_CHECKOUT_CONFIGURED (+20 more)

### Community 39 - "Community 39"
Cohesion: 0.07
Nodes (29): loadConceptWeakAreaRows(), mocks, unionGroup(), buildLegacyColumns(), buildSessionDynamicTail(), buildSessionStaticInstructions(), cooldownConceptSet(), DiscriminateRowPayload (+21 more)
...
Cohesion: 0.10
Nodes (32): MC_QUESTION, NONE, buildFlashcardActivityContext(), buildQuizActivityContext(), buildSafeBody(), cap(), capCodeWrite(), capRevealing() (+24 more)

### Community 42 - "Community 42"
Cohesion: 0.07
Nodes (23): MageRevealingParts, QuestionImageData, QuizMode, QuizQuestion, QuizViewerProps, ghostExtra, GradedResultAction, GradedResultPanelProps (+15 more)

### Community 43 - "Community 43"
Cohesion: 0.08
Nodes (11): BRAND, KIND_LABEL, shuffleNonIdentity(), parseYearForSort(), hashKey(), mulberry32(), shuffleByKey(), Token (+3 more)

### Community 44 - "Community 44"
Cohesion: 0.10
Nodes (23): AppMobileNav(), NAV, AppSidebar(), NAV, GLYPHS, NavIcon(), UnlockProvider(), DashboardChrome() (+15 more)
...
Cohesion: 0.10
Nodes (26): ANNOTATE_ANSWER_TOOL, CHAT_STUDY_PLAN_TOOL, extractToolUses(), FLASHCARD_TOOL_WITH_FIGURES, MINDMAP_TOOL, PRESENTATION_TOOL, QUIZ_TOOL_V2_WITH_FIGURES, YOUTUBE_VIDEOS_TOOL (+18 more)
...
Cohesion: 0.08
Nodes (23): CancelPathDialog(), DeletePathDialog(), ResetPathDialog(), findContinueSlot(), DialogTarget, GeneratingCard(), isPathDone(), isStuckGenerating() (+15 more)

### Community 52 - "Community 52"
Cohesion: 0.12
Nodes (20): getPreviewServerSnapshot(), getPreviewSnapshot(), parse(), StoredPreview, StoredPreviewLesson, subscribePreview(), getSampleRunServerSnapshot(), getSampleRunSnapshot() (+12 more)
...
Cohesion: 0.08
Nodes (22): DashboardLayout(), AchievementDef, ACHIEVEMENTS, UserStats, getServerAuthToken(), PROFILE_SELECT, ProfilePage(), AchievementsSection() (+14 more)
...
Cohesion: 0.14
Nodes (22): POST(), normalizeEmail(), C, getAppUrl(), getFromAddress(), getResend(), renderPasswordResetEmail(), renderVerificationEmail() (+14 more)
...
Cohesion: 0.12
Nodes (26): clientIpFromHeaders(), trustedProxyHops(), rateLimitedHtml(), rateLimitedResponse(), AUTH_LOGIC_PATTERNS, config, CONTENT_SECURITY_POLICY, GLOBAL_THROTTLE_MAX (+18 more)
...
Cohesion: 0.09
Nodes (15): Derived, FetchState, ExamHubViewProps, Align, PathConnectorProps, X_FRAC_BY_ALIGN, NodeState, PathPhase (+7 more)

### Community 65 - "Community 65"
Cohesion: 0.16
Nodes (24): AiUsageEvent, globalForAnthropic, generateAndPersistTitle(), sanitizeTitle(), applyGlm(), FEATURE_TO_STAGE, fromToken(), isGlmComposition() (+16 more)
...
Cohesion: 0.11
Nodes (24): assemblePlanView(), AssemblePlanViewArgs, buildPlanCandidates(), deriveMilestones(), isoDateOnly(), isoDayDiff(), itemHref(), itemReason() (+16 more)
...
Cohesion: 0.11
Nodes (20): PathStructureToolInput, ConceptEdgeSource, DbClient, deriveStructuralEdgesForPlan(), SlotRow, SOURCE_PRIORITY, ConceptFixture, EdgeFixture (+12 more)
...
Cohesion: 0.13
Nodes (20): BurgerMenuProps, COLORS, NavItem, PRIMARY_NAV_ITEMS, SECONDARY_NAV_ITEMS, getPageTitle(), Header(), ADMIN_BADGE (+12 more)

### Community 76 - "Community 76"
Cohesion: 0.12
Nodes (21): AssessmentResultPanel(), ActivityLite, AnnotatedActivity, AnnotatedPhase, AnnotatedSlot, annotatePhases(), GateResult, gradeForPercentage() (+13 more)
...
Cohesion: 0.18
Nodes (9): fuzzyMatch(), substituteBlankMarker(), lowlight, FillBlankRenderer(), AnyQuestionRenderer, TranslationRenderer(), QuestionProps, QuizQuestionForRender (+1 more)

### Community 80 - "Community 80"
Cohesion: 0.12
Nodes (15): metadata, Checkpoint, CHIPS, CP, SEG_H, capCorpusText(), extractCappedCorpus(), extractPdf() (+7 more)

### Community 81 - "Community 81"
Cohesion: 0.11
Nodes (17): AppearanceSettingsPage(), ResolvedTheme, ThemeContext, ThemeContextValue, ThemePreference, useTheme(), ensureStorageListener(), fire() (+9 more)

### Community 82 - "Community 82"
Cohesion: 0.12
Nodes (18): formatPrice(), FeatureType, INTERVAL_LABEL, INTERVAL_SUFFIX, isPppCurrency(), LIFETIME_LIMITS, monthlyEquivalent(), PPP_CURRENCIES (+10 more)
...
Cohesion: 0.10
Nodes (16): getCosmetic(), CandidateGroupKey, ExamScopeEditorProps, GROUPS, ScopeCandidate, CONFETTI, CONFETTI_COLORS, COSMETIC_TYPE_LABEL (+8 more)

### Community 89 - "Community 89"
Cohesion: 0.13
Nodes (20): ChatMessage, DonePayload, SSEEvent, StreamStatus, UseStreamingChatOptions, ChatStreamOptions, MageActionCard, MageActionsPayload (+12 more)
...
Cohesion: 0.15
Nodes (17): APPLE_JWKS, AppleIdTokenClaims, NativeApplePayload, POST(), hydrateTokenFromDb(), findOrCreateOAuthUser(), OAuthProvider, OAuthUserInput (+9 more)
...
Cohesion: 0.15
Nodes (11): attachUpstreamGapHints(), ConceptWeakArea, ConceptWeakAreaColdStart, ConceptWeakAreaCoverage, weaknessTrainingUiEnabled(), resolveNudgesForUser(), WeakSpotsPage(), BAND_META (+3 more)

### Community 102 - "Community 102"
Cohesion: 0.16
Nodes (15): buildSourceIdentityIndex(), allocateBudget(), computeCorpusFit(), corpusBudget(), CorpusFitItem, MaterialCorpusEntry, MaterialKind, PathCorpusEstimate (+7 more)

### Community 103 - "Community 103"
Cohesion: 0.16
Nodes (14): turnstileConfigured(), verifyTurnstile(), assembleTimestampedTranscript(), CaptionsUnavailableError, extractVideoId(), extractYouTubeTranscript(), formatTimestamp(), searchYouTubeVideos() (+6 more)
...
Cohesion: 0.12
Nodes (5): ReviewGrade, FlashcardCard, GradeButtonRow(), ReviewQuality, ReviewGrade
...
Cohesion: 0.17
Nodes (16): SUBJECT_IDS, CallResult, EVAL_SUBJECTS, evalThresholds(), main(), makeContext(), parseSubjectArg(), pct() (+8 more)
...
Cohesion: 0.23
Nodes (12): getAuthContext(), startChatStream(), formatExamStudyState(), dbGroundingLoader(), resolveMageGrounding(), buildMageSourceManifest(), mageContextKey(), detectExplicitWebIntent() (+4 more)
...
Cohesion: 0.29
Nodes (11): callRegister(), mocks, USER, computeAge(), meetsMinimumAge(), parseBirthDate(), enforceIpCap(), generatePlaceholderUsername() (+3 more)

### Community 129 - "Community 129"
Cohesion: 0.21
Nodes (9): logOAuthDenial(), oauthProviders, AuthenticatedContext, mocks, validateAuthToken(), validAuthVersion(), getIpFromHeaders(), logSecurityEvent() (+1 more)

### Community 130 - "Community 130"
Cohesion: 0.20
Nodes (14): CLASSIFY_SUBJECTS_TOOL, ANTHROPIC_SYSTEM_PROMPT, BUCKETS_AND_RULES, classifySubjects(), ClassifySubjectsOpts, classifyViaAnthropic(), classifyViaGemini(), findToolUse() (+6 more)
...
Cohesion: 0.19
Nodes (10): Params, POST(), staleGenerationCutoff(), DELETE(), GET(), NO_REFUND, Params, RefundOutcome (+2 more)
...
## Knowledge Gaps
- **1740 isolated node(s):** `semi`, `trailingComma`, `singleQuote`, `printWidth`, `tabWidth` (+1735 more)
...
- **Why does `internalErrorResponse()` connect `Community 1` to `Community 0`, `Community 128`, `Community 34`, `Community 3`, `Community 122`, `Community 138`, `Community 46`, `Community 143`, `Community 207`, `Community 26`, `Community 59`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `useBreakpoint()` connect `Community 29` to `Community 33`, `Community 8`, `Community 9`, `Community 106`, `Community 75`, `Community 44`, `Community 42`, `Community 12`, `Community 105`, `Community 113`, `Community 53`, `Community 55`, `Community 60`, `Community 94`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `AppShell()` connect `Community 10` to `Community 100`, `Community 5`, `Community 8`, `Community 105`, `Community 14`, `Community 47`, `Community 15`, `Community 156`, `Community 17`, `Community 51`, `Community 55`, `Community 119`, `Community 58`, `Community 28`, `Community 29`?**
