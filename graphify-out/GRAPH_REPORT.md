...
## Corpus Check
- 16591 files · ~14,511,582 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 60832 nodes · 90601 edges · 8736 communities (5809 shown, 2927 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 729 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8c5e4400`
...
- [[_COMMUNITY_Page|Page]]
- [[_COMMUNITY_Layout|Layout]]
- [[_COMMUNITY_Pro-access|Pro-access]]
- [[_COMMUNITY_Route|Route]]
...
1. `internalErrorResponse()` - 383 edges
2. `getAuthUserId()` - 352 edges
3. `unauthorizedResponse()` - 344 edges
4. `successResponse()` - 301 edges
5. `notFoundResponse()` - 229 edges
6. `badRequestResponse()` - 226 edges
7. `React` - 221 edges
...
## Communities (8736 total, 2927 thin omitted)
...
Cohesion: 0.04
Nodes (69): GET(), callPost(), mocks, approveRequest(), callApprove(), callReject(), mocks, rejectRequest() (+61 more)

### Community 2 - "API Route Handlers"
Cohesion: 0.03
Nodes (278): GET(), POST(), Params, POST(), GET(), DELETE(), GET(), GET() (+270 more)

### Community 3 - "Path Generation Engine"
Cohesion: 0.00
Nodes (693): isObject(), 1072(), 1108(), 1148(), 116(), 1181(), 1291(), 1385() (+685 more)

### Community 4 - "Path Translation"
Cohesion: 0.03
Nodes (136): POST(), POST(), Params, ALLOWED_TYPES, mimeFromExtension(), Params, POST(), ALLOWED_TYPES (+128 more)

### Community 5 - "Cosmetics & Avatars"
Cohesion: 0.03
Nodes (122): encoder, FORMATTING_RULES, InlineAction, isValidAction(), Params, SYSTEM_PROMPTS, ESSAY_TOOL_FULL, ESSAY_TOOL_GRAMMAR (+114 more)

### Community 6 - "Notebook Modals & Sizing"
Cohesion: 0.01
Nodes (244): captureServerEvent(), getClient(), FilterMode, formatCount(), ListResponse, OTHER_LANGUAGES, PathCard(), PathListItem (+236 more)

### Community 7 - "Storage & Upload"
Cohesion: 0.03
Nodes (72): BackgroundCosmetic, BaseCosmetic, Cosmetic, COSMETICS, CosmeticType, FrameCosmetic, getCosmeticsByType(), NameColorCosmetic (+64 more)

### Community 8 - "Auth Middleware & Signup"
Cohesion: 0.02
Nodes (80): AdminLayout(), AdminUser, NAV_ITEMS, NavItem, AdminDashboardPage(), fmtNum(), Stats, ChatGroup (+72 more)

### Community 10 - "Usage Limits & Quotas"
Cohesion: 0.15
Nodes (24): safeLinkHref(), addMark(), convertChildren(), convertElement(), convertListItems(), convertTable(), ImageDownloader, onenoteHtmlToPlainText() (+16 more)

### Community 11 - "Achievements & DB Core"
Cohesion: 0.00
Nodes (683): 1072(), 1108(), 1148(), 116(), 1291(), 1385(), 1548(), 1625() (+675 more)

### Community 12 - "Path Checkpoint Viewers"
Cohesion: 0.07
Nodes (42): ActionButton(), AdminHeader(), Chip(), CHIP_PALETTE, ChipTone, Column, DataTable(), EmptyShell() (+34 more)

### Community 13 - "Study Groups & Cowork"
Cohesion: 0.01
Nodes (71): 1181(), 2731(), 5367(), 8454(), 9452(), addCachedImageOps(), adjustMapping(), Annotation (+63 more)
...
Cohesion: 0.09
Nodes (26): ensureWorkerOnDisk(), extractPdfText(), getPdfjs(), loadPdfjs(), processPage(), WORKER_URL, DescribePageInput, PdfPageUsage (+18 more)

### Community 16 - "Quiz Question Renderers"
Cohesion: 0.04
Nodes (47): useCoarsePointer(), ModalDimensions, useModalDimensions(), CommitResult, ImportGroup, ImportJobInfo, ImportMode, ImportPhase (+39 more)

### Community 17 - "Notebook Sidebar & Workspace"
Cohesion: 0.01
Nodes (74): 2731(), 3440(), 3650(), 4328(), 5367(), 7566(), 8454(), 9452() (+66 more)
...
Cohesion: 0.03
Nodes (53): DocumentItem, DocumentListProps, PathGenerationProgress, PathGenerationStatus, ProgressEnvelope, usePathGenerationStream(), UsePathGenerationStreamResult, ACTIVITY_LABEL (+45 more)
...
Cohesion: 0.08
Nodes (21): blockquoteBlockSchema, bulletListBlockSchema, calloutBlockSchema, calloutChildSchema, codeBlockSchema, docModelBlockSchema, docModelSchema, headingBlockSchema (+13 more)
...
Cohesion: 0.02
Nodes (117): AnswerSubmission, CALLOUT_RENDER_META, CALLOUT_TYPE_BY_MARKER, CalloutMarkerType, SubjectDef, shuffleNonIdentity(), PistonExecuteOptions, CodeOutputParsed (+109 more)

### Community 26 - "Theme & Haptics"
Cohesion: 0.07
Nodes (36): DocModelBlock, BBOX, BLOCK, CALLOUT_CHILD, CHILD_LIST, DOC_MODEL_JSON_SCHEMA, LIST_ITEM, LIST_ITEM_LEAF (+28 more)

### Community 27 - "PDF Import Engine"
Cohesion: 0.01
Nodes (132): AppearanceFilter, applyAssist(), Arc, Area, ariaLabel(), Barcode, BatchOutput, Bind (+124 more)

### Community 28 - "OneNote Import & MS Auth"
Cohesion: 0.01
Nodes (135): AppearanceFilter, applyAssist(), Arc, Area, ariaLabel(), Barcode, BatchOutput, Bind (+127 more)

### Community 29 - "Mascot & Celebrations"
Cohesion: 0.01
Nodes (230): is_function, is_function<Ret(Args..., ...)BOOST_TT_NOEXCEPT_DECL>, is_function<Ret(Args..., ...)const BOOST_TT_NOEXCEPT_DECL>, is_function<Ret(Args..., ...)const volatile BOOST_TT_NOEXCEPT_DECL>, is_function<Ret(Args..., ...)volatile BOOST_TT_NOEXCEPT_DECL>, is_function<Ret BOOST_TT_DEF_CALL(Args...)BOOST_TT_NOEXCEPT_DECL>, is_function<Ret BOOST_TT_DEF_CALL(Args...)const BOOST_TT_NOEXCEPT_DECL>, is_function<Ret BOOST_TT_DEF_CALL(Args...)const volatile BOOST_TT_NOEXCEPT_DECL> (+222 more)
...
Cohesion: 0.04
Nodes (87): callPost(), mocks, tiptapJsonToPlainText(), computeCost(), computeModelCost(), CostBreakdown, costForCall(), COSTS (+79 more)

### Community 32 - "Multi-PDF Import Flow"
Cohesion: 0.01
Nodes (83): namespace, facebook(), std(), namespace, facebook(), namespace, facebook(), namespace (+75 more)

### Community 33 - "Practice & Study Stats"
Cohesion: 0.02
Nodes (59): addHex(), Ascii85Stream, AsciiHexStream, BinaryCMapReader, BinaryCMapStream, BrotliDecode, BrotliStream, bytesToString() (+51 more)

### Community 34 - "Editor Toolbar & Callouts"
Cohesion: 0.02
Nodes (70): 1828(), 3068(), 4114(), 456(), 7629(), $addHTML, AstArgument, AstBinaryOperation (+62 more)

### Community 35 - "TipTap Page Editor & Math"
Cohesion: 0.03
Nodes (59): ExamForm(), Tab, TABS, PresentationButton(), ensureStorageListener(), fire(), haptics, hapticsEnabled() (+51 more)
...
Cohesion: 0.01
Nodes (120): FlashcardSetRow, ExamItem, NotebookOption, PathFetchState, ExamFormProps, BreadcrumbItem, FolderBreadcrumbsProps, CONNECTING_STATE (+112 more)
...
Cohesion: 0.04
Nodes (77): GET(), PathAccessResponse, GET(), CurrencyResponse, useCurrency(), useScrollReveal(), UseScrollRevealOptions, CanvasIcon() (+69 more)

### Community 41 - "Tiers & Pricing"
Cohesion: 0.02
Nodes (184): is_function<R(&&)()>, is_function<R(&&)(Arg1)>, is_function<R(&&)(Arg1, Arg2)>, is_function<R(&&)(Arg1, Arg2, Arg3)>, is_function<R(&&)(Arg1, Arg2, Arg3, Arg4)>, is_function<R(&&)(Arg1, Arg2, Arg3, Arg4, Arg5)>, is_mem_fun_pointer_select, is_mem_fun_pointer_select<false> (+176 more)

### Community 42 - "PDF.js Text Extraction"
Cohesion: 0.03
Nodes (84): CloneResponse, Params, POST(), callPost(), mocks, callGet(), mocks, callGet() (+76 more)
...
Cohesion: 0.03
Nodes (66): DerivedPath, Derived, FetchState, CheckpointIcon(), CheckpointIconProps, CheckpointKind, LockIcon(), ACTIVITY_ICONS (+58 more)

### Community 48 - "CreateChatModal"
Cohesion: 0.05
Nodes (48): Params, PATCH(), PatchBody, toUnlockedPayload(), AssessmentBody, Params, POST(), unlockCosmeticsForAchievement() (+40 more)
...
Cohesion: 0.02
Nodes (74): 1828(), 3068(), 4114(), 7629(), $addHTML, AESBaseCipher, AstArgument, AstBinaryOperation (+66 more)

### Community 51 - "OnboardingWizard"
Cohesion: 0.02
Nodes (63): ResetPasswordFormProps, TurnstileApi, TurnstileWidget(), TurnstileWidgetProps, Window, VerifyCodeFormProps, ResolvedTheme, ThemeContext (+55 more)
...
Cohesion: 0.01
Nodes (147): not_satisfied, wrap_constraints, is_integral, is_signed, make_unsigned, make_unsigned_imp, make_unsigned_imp<T, false>, make_unsigned_or_unbounded (+139 more)

### Community 54 - "MatchPairsRenderer"
Cohesion: 0.03
Nodes (34): 3110(), 456(), ChoiceWidgetAnnotation, deepCompare(), Dict, ErrorFont, escapeString(), FakeUnicodeFont (+26 more)
...
### Community 58 - "DrawingOverlay"
Cohesion: 0.16
Nodes (16): calloutHeavy(), cleanText(), corrupt(), encrypted(), FIXED_DATE, FIXTURE_DIR, german(), giant200p() (+8 more)

### Community 59 - "UserName"
Cohesion: 0.04
Nodes (47): formatTime(), PomodoroPhase, TimerContext, TimerContextValue, TimerMode, TimerProvider(), useTimer(), UnlockProvider() (+39 more)
...
Nodes (133): and_impl<
  ...
  >, is_lambda_expression, lambda, lambda_impl, lambda_impl< int_<i_> >, lambda_or, lambda_or< BOOST_MPL_PP_ENUM(n_,false) > (+125 more)

### Community 62 - "Route"
Cohesion: 0.19
Nodes (19): blockToNode(), collectDeepStrings(), collectDiagramColumnStrings(), decodeEntities(), extractInner(), findMatchingClose(), isLikelyHeading(), parseHtmlTable() (+11 more)

### Community 65 - "Normalize"
Cohesion: 0.05
Nodes (67): buildTextSample(), ClassifyFile, POST(), GeminiTextStreamResult, GeminiTextUsage, joinNonEmpty(), streamGeminiChatText(), StreamGeminiChatTextOpts (+59 more)
...
Cohesion: 0.02
Nodes (82): has_const_time_erase, has_const_time_insert, has_native_replace, has_stable_iterators, apply, AUX778076_OP_IMPL_NAME<integral_c_tag,integral_c_tag>, has_rebind, get (+74 more)
...
Cohesion: 0.03
Nodes (54): ALLOWED_EXTENSIONS, FileUpload(), FileUploadProps, UploadContext, UploadResult, useDirectUpload(), UseDirectUploadReturn, ChatMessage (+46 more)
...
Cohesion: 0.03
Nodes (58): adjustTrueTypeToUnicode(), adjustType1ToUnicode(), adjustWidths(), amendFallbackToUnicode(), applyStandardFontGlyphMap(), buildAddOperation(), buildMinOperation(), buildMulOperation() (+50 more)

### Community 88 - "Index"
Cohesion: 0.02
Nodes (25): 2195(), 3110(), 3392(), 5781(), 7566(), BooleanElement, ColorConverters, DateElement (+17 more)
...
### Community 90 - "FireStreakTakeover"
Cohesion: 0.02
...
### Community 91 - "Currency"
Cohesion: 0.05
Nodes (99): b, BinaryPredicate, bool_, BOOST_INTRUSIVE_FORCEINLINE, BOOST_MOVABLE_BUT_NOT_COPYABLE, BOOST_RV_REF, BOOST_STATIC_ASSERT, cache_last (+91 more)

### Community 92 - "NotebookForm"
Cohesion: 0.02
Nodes (96): BOOST_MOVE_FORCEINLINE, add_const, add_const_lvalue_reference, add_const<T&>, add_lvalue_reference, add_lvalue_reference<const void>, add_lvalue_reference<const volatile void>, add_lvalue_reference<T&> (+88 more)

### Community 93 - "GroupChat"
Cohesion: 0.04
Nodes (22): 4204(), 9286(), CFFCompiler, CFFDict, CFFFDSelect, CFFOffsetTracker, CFFParser, CFFPrivateDict (+14 more)
...
Nodes (59): and_, and_<
  ...
  >, apply, contains_impl, apply, find_if_pred, BOOST_MPL_AUX_LAMBDA_SUPPORT, is_sequence (+51 more)

### Community 101 - "SaveDestinationModal"
Cohesion: 0.02
Nodes (94): add_rvalue_reference_impl<T>, add_rvalue_reference, BOOST_MOVE_FORCEINLINE, add_const, add_const_lvalue_reference, add_const<T&>, add_lvalue_reference, add_lvalue_reference<const void> (+86 more)
...
Cohesion: 0.03
Nodes (24): 2360(), A, Button, CalGrayCS, CalRGBCS, CCITTFaxDecoder, compileCharString(), CompositeGlyph (+16 more)
...
Cohesion: 0.03
Nodes (11): Binder, createDataNode(), createText(), DatasetReader, MetadataParser, parseXFAPath(), SimpleDOMNode, Template (+3 more)

### Community 108 - "Page"
Cohesion: 0.03
Nodes (15): AstNode, BaseLocalCache, BasePdfManager, BasePDFStreamRangeReader, BasePDFStreamReader, BaseShading, BaseStream, CMap (+7 more)
...
### Community 130 - "Toast"
Cohesion: 0.03
Nodes (16): AstNode, BaseLocalCache, BasePdfManager, BasePDFStreamRangeReader, BasePDFStreamReader, BaseShading, BaseStream, ColorSpace (+8 more)

### Community 131 - "PathDiagram"
Cohesion: 0.03
Nodes (77): is_pointer_to_class, is_pointer_to_function, is_pointer_to_function<T*>, is_reference_to_class, is_reference_to_const, is_reference_to_const<T const&>, is_reference_to_const<T const volatile&>, is_reference_to_function (+69 more)
...
Cohesion: 0.03
Nodes (36): 2360(), A, buildHuffmanTable(), Button, CompositeGlyph, createValidAbsoluteUrl(), decodeScan(), findNextFileMarker() (+28 more)
...
Cohesion: 0.04
Nodes (17): AlternateCS, CalGrayCS, CalRGBCS, CCITTFaxDecoder, DeviceCmykCS, IccColorSpace, IndexedCS, info() (+9 more)

### Community 143 - "Notes-to-page"
Cohesion: 0.02
Nodes (66): RUN, JBig2(), OpenJPEG(), addHex(), Ascii85Stream, AsciiHexStream, BinaryCMapReader, BinaryCMapStream (+58 more)
...
Cohesion: 0.30
Nodes (11): TipTapDoc, VideoNoteBlock, VideoNotes, blockToNodes(), blockToPlainText(), headingNode(), notesToPageDoc(), paragraph() (+3 more)
...
Cohesion: 0.04
Nodes (65): BOOST_DELETED_FUNCTION, D, Derived, difference_type, Facade, Facade1, Facade2, false_ (+57 more)
...
Nodes (62): and_<
                ...
                >, foo, p, lvalue_deref_helper, v, value_iterator, operator*, T (+54 more)

### Community 164 - "RemoteCursor"
Cohesion: 0.29
Nodes (9): ageDays(), APPLY, db, dbHost(), ID, listStuck(), main(), MODE (+1 more)

### Community 165 - "Tickets-detail.test"
Cohesion: 0.22
...
Cohesion: 0.04
Nodes (60): enable_if_interoperable, enable_if_interoperable_and_random_access_traversal, use_operator_brackets_proxy, BOOST_DELETED_FUNCTION, D, Derived, difference_type, Facade (+52 more)

### Community 171 - "ExamCountdown"
Cohesion: 0.04
Nodes (12): AppearanceStreamEvaluator, arrayBuffersToBytes(), BasePDFStream, ChunkedStream, ChunkedStreamManager, DefaultAppearanceEvaluator, MessageHandler, NetworkPdfManager (+4 more)

### Community 172 - "Legal Notice (Notemage)"
Cohesion: 0.33
Nodes (8): Doc, DocCategory, DocFrontmatter, DOCS_DIR, DocSummary, getDoc(), parseFrontmatter(), readDocFile()
...
Cohesion: 0.04
Nodes (14): addChildren(), arrayBuffersToBytes(), BasePDFStream, ChunkedStream, ChunkedStreamManager, DefaultAppearanceEvaluator, mayHaveChildren(), MessageHandler (+6 more)
...
### Community 184 - "Lemonsqueezy-webhook-hmac.test"
Cohesion: 0.04
Nodes (23): 7642(), 9835(), clearGlobalCaches(), clearPatternCaches(), clearPrimitiveCaches(), clearUnicodeCaches(), DataHandler, find() (+15 more)
...
### Community 191 - "Api-auth-coverage.test"
Cohesion: 0.29
...
### Community 199 - "Exam-reminders"
Cohesion: 0.08
Nodes (63): A, Allocator, const_iterator, const_reference, const_reverse_iterator, a(), at(), back() (+55 more)

### Community 200 - "Page"
Cohesion: 0.05
Nodes (23): ARCFourCipher, calculateMD5(), calculateSHA384(), calculateSHA512(), ch(), CipherTransform, CipherTransformFactory, Edge (+15 more)
...
### Community 205 - "Layout"
Cohesion: 0.06
Nodes (57): Allocator, Archive, BoolConstant, BOOST_DEDUCED_TYPENAME, BOOST_MULTI_INDEX_FUNCTION_PARAM_PACK, check_rollback_(), clear_(), emplaced_tag (+49 more)

### Community 206 - "Pro-access"
Cohesion: 0.33
...
### Community 208 - "BASELINE WORDLIST"
Cohesion: 0.33
...
Cohesion: 0.06
Nodes (12): 4204(), 9286(), CFFCompiler, CFFDict, CFFOffsetTracker, CFFParser, CFFPrivateDict, CFFStrings (+4 more)
...
Cohesion: 0.04
Nodes (17): B, Br, find(), FontFinder, FontInfo, fonts_getMetrics(), getCurrentPara(), I (+9 more)
...
Cohesion: 0.05
Nodes (47): apply, erase_key_impl< aux::set_tag >, apply, insert_impl< aux::set_tag >, set_insert_impl, next< s_iter<Set,set0<> > >, next< s_iter<Set,Tail> >, s_end_iter (+39 more)
...
Cohesion: 0.04
Nodes (49): make_slist_base_hook, make_slist_member_hook, slist_base_hook, slist_member_hook, eval_if, eval_if_c, nested_type_wknd, conjunction (+41 more)

### Community 261 - "Community 261"
Cohesion: 0.06
Nodes (50): integral_rank, integral_rank<bool>, integral_rank<char>, integral_rank<int>, integral_rank<long>, integral_rank<long_long_type>, integral_rank<short>, integral_rank<signed char> (+42 more)
...
Cohesion: 0.06
Nodes (15): assert(), compileCssFontInfo(), compileFontInfo(), compileSystemFontInfo(), convertBlackAndWhiteToRGBA(), convertRGBToRGBA(), convertToRGBA(), copyRgbaImage() (+7 more)
...
Cohesion: 0.04
Nodes (47): is_constructible, is_constructible_imp, is_constructible<Ref&, Arg>, is_constructible<Ref&, void>, is_constructible<T>, is_constructible<T, void>, is_constructible<void>, is_constructible<void const> (+39 more)
...
Cohesion: 0.06
Nodes (15): AlternateCS, AppearanceStreamEvaluator, CmykICCBasedCS, copyRgbaImage(), DeviceRgbaCS, fetchSync(), grayToRGBA(), IccColorSpace (+7 more)

### Community 286 - "Community 286"
Cohesion: 0.06
Nodes (9): Binder, createText(), DatasetReader, MetadataParser, parseXFAPath(), SimpleDOMNode, Template, writeXFADataForAcroform() (+1 more)
...
Cohesion: 0.05
Nodes (40): alignment_of_hack, c, t1, t2, empty_helper_t1, i, msvc_eti_base, msvc_eti_base_impl (+32 more)
...
Cohesion: 0.06
Nodes (25): Commands, compileGlyf(), decodeScan(), EvaluatorPreprocessor, findNextFileMarker(), FontRendererFactory, getFloat214(), Jbig2Image (+17 more)
...
Cohesion: 0.07
Nodes (10): 7642(), 9835(), clearGlobalCaches(), clearPatternCaches(), clearPrimitiveCaches(), clearUnicodeCaches(), GlobalColorSpaceCache, GlobalImageCache (+2 more)
...
Cohesion: 0.08
Nodes (5): Color, getColor(), getTransformMatrix(), Stipple, Util
...
Cohesion: 0.16
Nodes (18): buildCallbackHtml(), escapeHtml(), GET(), acquireTokenByCode(), disconnectMicrosoft(), freshMsalClient(), getAuthCodeUrl(), getMsalClient() (+10 more)
...
Cohesion: 0.25
Nodes (17): BOOST_TT_TRAIT_NAME, BOOST_TT_TRAIT_NAME<T, U, boost::binary_op_detail::dont_care>, BOOST_TT_TRAIT_NAME<T, U, void>, BOOST_TT_TRAIT_NAME, BOOST_TT_TRAIT_NAME<T, boost::binary_op_detail::dont_care>, BOOST_TT_TRAIT_NAME<T, void>, BOOST_TT_TRAIT_NAME, BOOST_TT_TRAIT_NAME<T, U, boost::binary_op_detail::dont_care> (+9 more)
...
Cohesion: 0.18
Nodes (10): equivalent_function_pointer, has_one_operator_call_helper, is_likely_stateless_lambda, is_likely_stateless_lambda<
  T,
  typename boost::enable_if_<has_one_operator_call<T>::value>::type>, equivalent_function_pointer, has_one_operator_call_helper, is_likely_stateless_lambda, is_likely_stateless_lambda<
  T,
  typename boost::enable_if_<has_one_operator_call<T>::value>::type> (+2 more)
...
Cohesion: 0.22
Nodes (8): BOOST_MPL_AUX_LAMBDA_SUPPORT, shift_left, shift_left_impl, shift_left_impl< integral_c_tag,integral_c_tag >, shift_left_impl< na,na >, shift_left_impl< na,Tag >, shift_left_impl< Tag,na >, shift_left_tag
...
## Knowledge Gaps
- **16974 isolated node(s):** `name`, `version`, `private`, `description`, `main` (+16969 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **2927 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `React` connect `Chat Thread & Streaming` to `Notebook Modals & Sizing`, `Storage & Upload`, `Auth Middleware & Signup`, `Path Checkpoint Viewers`, `Quiz Question Renderers`, `Admin Dashboard`, `Quiz Grading & Safe Math`, `Sample Paths & Cloning`, `Model Routing & AI Telemetry`, `File Upload & Validation`, `TipTap Page Editor & Math`, `Lemon Squeezy Billing`, `Route`, `Study Pack Wizard`, `PdfImportProgressModal`, `Community 813`, `Engine-text.test`, `OnboardingWizard`, `Paths-clone.test`, `UserName`, `CoWorkChat`, `Gemini-ingest`, `Privacy Policy (Notemage)`, `Community 226`, `Community 740`, `Community 229`, `IsInsideNativeShell`, `Community 624`, `Scanner`, `Terms of Service (Notemage)`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `Void` connect `Moderation Layer 4 / Reports` to `TurnstileWidget`, `Community 296`, `Community 813`, `Community 1296`, `GroupChatMessage`, `Community 1333`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `isObject()` connect `Path Generation Engine` to `Path-gating`, `Theme & Haptics`, `Achievements & DB Core`, `Study Groups & Cowork`?**
...
- **Are the 91 inferred relationships involving `getAuthUserId()` (e.g. with `DELETE()` and `GET()`) actually correct?**
  _`getAuthUserId()` has 91 INFERRED edges - model-reasoned connections that need verification._
- **Are the 88 inferred relationships involving `unauthorizedResponse()` (e.g. with `DELETE()` and `GET()`) actually correct?**
  _`unauthorizedResponse()` has 88 INFERRED edges - model-reasoned connections that need verification._
- **What connects `name`, `version`, `private` to the rest of the system?**
  _16974 weakly-connected nodes found - possible documentation gaps or missing edges._